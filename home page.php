...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html" id="logo"><span>T</span>ravel<span>T</span>our</a>
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            ...
            <form class="d-flex">
              ...
              <div class="dropdown">
                <img src="profile.jpg" alt="User Profile" class="profile-pic rounded-circle" width="40" height="40" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <li><a class="dropdown-item" href="log out.html">Logout</a></li>
                </ul>
            </div>
    ...
    <footer id="footer">
      ...
      <div class="copyright">
        <p>&copy;Copyright Najamus Saqib. All Rights Reserved</p>
      </div>
    </footer>
    <!-- Footer End -->
