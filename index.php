...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container">
          <a class="navbar-brand" href="index.php" id="logo"><span>T</span>ravel<span>T</span>our</a>
  ...
  <!-- Login button styled as a button but linking to login form -->
  <button class="btn btn-primary" type="button" onclick="window.location.href='login form.php';">Login</button>
</form>
    ...
    <div class="home">
        <div class="content">
            ...
            <a href="login form.php">Book Place</a>
        </div>
    </div>
    <!-- Home Section End -->
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="login form.php">Book Now</a>
              </div>
            </div>
    ...
    <!-- Footer Start -->
    <footer id="footer">
      <h1><span>T</span>ravel<span>T</span>our</h1>
      ...
      <div class="credit">
        <p>Designed By <a href="#">Najam $ Ram</a></p>
      </div>
      <div class="copyright">
        <p>&copy;Copyright ICT502. All Rights Reserved</p>
      </div>
    </footer>
    <!-- Footer End -->
